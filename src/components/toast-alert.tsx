...
import toast, { Toast as ToastMessage } from 'solid-toast';
import { BOOSTRAP_CONTEXTUAL_VARIENT, useLayoutContext } from '~/components/theme';
...
export const ToastAlert: ParentComponent<ToastAlertProps> = (props) => {
