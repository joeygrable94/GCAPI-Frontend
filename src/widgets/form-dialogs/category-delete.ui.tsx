...
type CategoryDeleteFormDialogProps = {
  category: CategoryRead;
  title: JSX.Element | string;
  description?: JSX.Element | string;
};

const CategoryDeleteFormDialog: Component<CategoryDeleteFormDialogProps> = (props) => {
  ...
  const handleSubmit = () => {
    setPending(true);
    finActions.categories.delete(props.category.id);
    setTimeout(() => {
      setPending(false);
      setIsSubmitted(true);
    }, 1000);
        ...
        <Stack class="w-100 mb-2 d-flex flex-row flex-nowrap justify-content-between">
          ...
          >
            <Switch>
              ...
              <Match when={!pending()}>Delete Category</Match>
            </Switch>
          </Button>
        </Stack>
      }
...
export default CategoryDeleteFormDialog;
*/
