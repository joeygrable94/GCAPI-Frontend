...
export const validateUsername = function (username: unknown) {
  // load env vars
  const USERNAME_LENGTH_MIN: number = parseInt(import.meta.env.VITE_USERNAME_LENGTH_MIN)
  const USERNAME_LENGTH_MAX: number = parseInt(import.meta.env.VITE_USERNAME_LENGTH_MAX)
  // check min length
...
export const validatePassword = function (password: unknown) {
  // load env vars
  const PASSWORD_LENGTH_MIN: number = parseInt(import.meta.env.VITE_PASSWORD_LENGTH_MIN)
  const PASSWORD_LENGTH_MAX: number = parseInt(import.meta.env.VITE_PASSWORD_LENGTH_MAX)
  // check min length
